...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--clevr_mini_img_dir', default='/users/sbsh670/data/clevr/CLEVR_v1.0/images/train', type=str, help='clevr-mini image directory')
        self.parser.add_argument('--clevr_mini_ann_path', default='/users/sbsh670/data/clevr/CLEVR_v1.0/scenes/CLEVR_train_scenes.json', type=str, help='clevr-mini objects annotation file')
        
        self.parser.add_argument('--concat_img', default=1, type=int, help='concatenate original image when sent to network')
        self.parser.add_argument('--split_id', default=63000, type=int, help='splitting index between train and val images')
